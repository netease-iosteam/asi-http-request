Pod::Spec.new do |s|
  s.name     = 'ASIHTTPRequest-netease'
  s.version  = '1.8.1'
  s.summary  = 'Easy to use CFNetwork wrapper for HTTP requests, Objective-C, Mac OS X and iPhone.'
  s.homepage = 'https://github.com/netease-iosteam/asi-http-request'
  s.author   = { 'Ben Copsey' => 'ben@allseeing-i.com' }
  s.license  = 'New BSD License'
  s.source   = { :git => 'https://github.com/netease-iosteam/asi-http-request.git'}
